<?php
/**
 * Wishlist for WooCommerce - Wish list customization
 *
 * @version 3.5.1
 * @since   1.0.0
 * @author  WPFactory.
...
if ( ! class_exists( 'Alg_WC_Wish_List_Customization_Wish_List' ) ) {
	...
	class Alg_WC_Wish_List_Customization_Wish_List {
		...
		public static function get_wish_list_custom_style() {
			// Options
			$icon_color                      = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_STYLE_WISH_LIST_SHARE_ICON_COLOR, '#a0a0a0' ), '#a0a0a0' );
			$icon_hover_color                = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_STYLE_WISH_LIST_SHARE_ICON_COLOR_HOVER, '#a0a0a0' ), '#a0a0a0' );
			...
			$remove_btn_icon_color           = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_REMOVE_BTN_ICON_COLOR, '#DC3232' ), '#DC3232' );
			$remove_btn_hover_color          = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_REMOVE_BTN_ICON_COLOR_HOVER, '#DC3232' ), '#DC3232' );
			...
			$tab_delete_btn_color       = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_TAB_DELETE_BUTTON_COLOR,'#DC3232' ), '#DC3232' );
			$tab_delete_btn_hover_color = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_TAB_DELETE_BUTTON_HOVER_COLOR,'#DC3232' ), '#DC3232' );

			$popup_bg_color                 = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_BG_COLOR,'#ffffff' ), '#ffffff' );
			$popup_font_color               = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_FONT_COLOR,'#000' ), '#000' );
			$popup_list_item_color          = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_LIST_ITEM_COLOR,'#eee' ), '#eee' );
			$popup_checkbox_checked_color   = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_CHECKBOX_CHECKED_COLOR,'#255cd2' ), '#255cd2' );
			$popup_checkbox_unchecked_color = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_CHECKBOX_UNCHECKED_COLOR,'#47474936' ), '#47474936' );
			$popup_checkbox_tick_color      = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_CHECKBOX_TICK_COLOR,'#fff' ), '#fff' );
			$popup_btn_color                = Alg_WC_Wish_List_CSS_Sanitizer::color( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_MULTIPLE_POPUP_BUTTON_COLOR,'#eeeeee' ), '#eeeeee' );
			...
			$wl_table_align_mobile = Alg_WC_Wish_List_CSS_Sanitizer::keyword( get_option( 'alg_wc_wl_style_wish_list_t_alignment_mobile', 'default' ), array( 'left', 'center', 'right', 'justify', 'initial', 'inherit' ), 'default' );
			if ( 'default' !== $wl_table_align_mobile ) {
		...
		public static function get_tab_icon_custom_style() {
			...
			$icon     = preg_replace( '/[^a-f0-9]/i', '', sanitize_text_field( get_option( Alg_WC_Wish_List_Settings_Style::OPTION_STYLE_MY_ACCOUNT_TAB_ICON, 'f004' ) ) );
			$icon_str = $icon;
