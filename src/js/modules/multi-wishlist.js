...
var multiWishlist = {
	...
	bindEvents: function () {
		...
		var toggleEvents = self.isTouchScreen()
			? alg_wc_wl_ajax.toggle_item_events.touchscreen.join( ' ' )
			: alg_wc_wl_ajax.toggle_item_events.default.join( ' ' );
		...
		$( document ).on( 'click', settings.algwcwishlistmodalSaveWishlist, function () {
			...
			var btns = $( alg_wc_wl_toggle_btn.btn_class +
	...
	getSaveMultipleWishlistItemData: function () {
		var arr = [];
	...
	getDeleteWishlistData: function () {
	...
	loadWishlist: function () {
		...
		$( s.algwcwishlistContainer )
			.html( '<li><i class="loading fas fa-sync-alt fa-spin fa-fw"></i></li>' );
