...
= 3.1.3 - 15/11/2024 =
* Fix - Resolved Reflected XSS vulnerability.
* Dev - Wishlist Page - Quantity - Disabled quantity selection for the free version.
* Dev - Code refactoring and cleanup.
* Dev - Update cross-selling library.
* WC tested up to: 9.4.
* Tested up to: 6.7.

= 3.1.2 - 23/10/2024 =
* Dev - New option added to manage text "Default Wishlist" when using Multiple wishlists.

= 3.1.1 - 16/10/2024 =
* Fix - WPFactory menu and submenus are now visible and accessible.
* Fix - Fixed problem on `remove_all_from_wish_list()` function.
...
* WC tested up to: 9.0.
* Add - Language File Dutch and French.
...
= 3.0.2 - 28/05/2024 =
* Fix - constraint. 
* Fix - My account issue with multiple wishlist.
...
= 2.3.7 - 29/04/2024 =
* Fix - Restructure the plugin to gnerate free and pro plugin from same codebase.
